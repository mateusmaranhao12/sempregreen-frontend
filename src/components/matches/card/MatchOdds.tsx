import { FaChartBar, FaFlag, FaArrowUp, FaArrowDown } from 'react-icons/fa'
...
export default function MatchOdds({ odds }: MatchOddsProps) {
    console.log('ODDS RECEBIDAS NO FRONT:', odds)
                ...
                return (
                    <div key={index} className='text-center flex-shrink-0 w-[90px] sm:w-[100px] md:w-auto'>
                        ...
                        <div className='flex items-center justify-center gap-1 text-lg'>
                            ...
                            {odd.countryCode && <FaFlag className='text-gray-700' size={14} />}
                        </div>
                    </div>
                )
            })}
